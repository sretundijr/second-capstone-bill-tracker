...
const buildTable = () => bills.map((item, index) => HOUSE_HTML(item, index));
...
const allExpensesExplainedHtml = () => `<h4 class="all-expenses-rendering">All Monthly Expenses</h4>
...
const roommateAmountExplainedHtml = () => `<h4 class="each-roommate-expense-js">Each Roommates total amount due</h4>
